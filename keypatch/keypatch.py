...
class Keypatch_Asm:
    ...
    def get_hardware_mode():
        ...
        if 'get_inf_structure' in dir(idaapi):
            
            inf = idaapi.get_inf_structure()
            inf_is_64bit = inf.is_64bit()
            inf_is_32bit = inf.is_32bit()
            
            try:
                cpuname = inf.procname.lower()
            except:
                cpuname = inf.procName.lower()
            ...
            # for IDA 9.0 beta (240807)
            inf_is_64bit = idaapi.inf_is_64bit()
            inf_is_32bit = idaapi.inf_is_32bit_exactly()
            cpuname = idaapi.inf_get_procname().lower()
